  ...
  return (
    <div className="w-full max-w-md scale-in">
      <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg shadow-2xl p-4 sm:p-6">
        ...
        <div className="bg-green-600 hover:bg-green-700 transition rounded mb-4">
          <button
            type="button"
            className="w-full py-2 px-4 text-white font-semibold flex items-center justify-center gap-2 text-sm"
          >
            <span>💬</span>
