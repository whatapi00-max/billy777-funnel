  ...
  return (
    <div className="w-full max-w-md scale-in">
      <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg shadow-2xl p-4 sm:p-6">
        ...
        <div className="rounded mb-4 overflow-hidden flex">
          ...
          <button
            type="button"
            className="flex-1 bg-green-500 hover:bg-green-600 transition py-3 px-4 text-white font-bold text-sm tracking-wider"
          >
            CLICK HERE
          </button>
        </div>
